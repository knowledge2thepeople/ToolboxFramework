...
@ToolMaker
public class ToolDependsOnADependencyOfADependencyToolMaker {
    ...
    @Tool("B")
    public String b(@UseTool("A") final String a) {
        return "B";
    }

    @Tool("C")
    public String c(@UseTool("B") final String b, @UseTool("A") final String a) {
        return "C";
    }
}
