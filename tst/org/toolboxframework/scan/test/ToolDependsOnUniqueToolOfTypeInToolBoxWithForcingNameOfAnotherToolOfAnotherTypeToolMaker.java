...
@ToolMaker
public class ToolDependsOnUniqueToolOfTypeInToolBoxWithForcingNameOfAnotherToolOfAnotherTypeToolMaker {

    @Tool
    public String hammer(@UseTool("score") final boolean notSure) {
        return "";
    }
}
