...
/**
 * This exception is raised if a tool is not found.
 * <p>
 ...
 * @version 1.0
 */
public class ToolNotFoundException extends ToolboxException {
    ...
    public ToolNotFoundException(final String message, final Throwable e) {
        super(message, e);
    }

    public ToolNotFoundException(final Throwable e) {
        super(e);
    }
}
