...
/**
 * This exception is raised if a circular dependency is discovered between tools
 ...
 * @version 1.0
 */
public class CircularDependencyException extends ToolScannerException {
    ...
    public CircularDependencyException(final String message, final Throwable e) {
        super(message, e);
    }

    public CircularDependencyException(final Throwable e) {
        super(e);
    }
}
